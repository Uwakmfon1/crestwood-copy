                    ...
                    <div class="d-sm-flex align-items-cneter">
                        <div class="d-flex align-items-center flex-fill">
                            <span class="avatar avatar-sm avatar-rounded me-3">
                                <img width="30" class="rounded-circle" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png" alt="" class="bg bg-dark-transparent">
                            </span>
                            <div>
                        ...
                        <li class="list-group-item border-0 border-bottom">
                            <div class="d-flex align-items-start gap-3 flex-wrap">
                                ...
                                <div class="flex-fill w-50">
                                    ...
                                    <div class="">
                                        <span class="badge bg-light text-default"><i class="ri-chat-4-line me-1"></i>{{ $support['created_at']->format('d M, Y \- h:i') }}</span>
