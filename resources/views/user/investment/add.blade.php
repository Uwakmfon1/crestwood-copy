...
@section('content')
    @if($setting['invest'] == 0)
        <div class="alert alert-fill-warning" role="alert">
            ...
            <strong style="font-size: 13px" class="small">Investment in packages is currently unavailable, check back later</strong>
        ...
        <div class="col-md-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('invest.store') }}" id="formToProcess" method="POST">
                        @csrf
