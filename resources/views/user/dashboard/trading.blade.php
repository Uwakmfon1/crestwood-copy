                            ...
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="dropdown mb-2">
                                    <button class="btn p-0" type="button">
                                        <i class="icon-lg text-muted pb-3px" data-feather="activity"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-responsive">
                        @foreach(auth()->user()->trades()->latest()->take(6)->get() as $trade)
                        <tr>
                    ...
                    <a href="{{ route('trades') }}" class="btn btn-primary btn-block">My Trades</a>
                </div>
            </div>
        </div>
        @endif
