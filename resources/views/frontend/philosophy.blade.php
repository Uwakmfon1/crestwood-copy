<!doctype html>
<html lang="en">
   <head data-ipt="How Betterment Manages Risks in Your Portfolio">
      <meta charset="utf-8">
      <title>How Betterment Manages Risks in Your Portfolio</title>
      <link rel="shortcut icon" href="../hubfs/Graphics/shared-assets/Favicon-navy-circle-1.png">
      <meta name="description" content="Betterment’s tools can keep you on track with the best chance of reaching your goals.">
      <script>
      ...
      <meta property="og:description" content="Betterment’s tools can keep you on track with the best chance of reaching your goals.">
      <meta property="og:title" content="How Betterment Manages Risks in Your Portfolio">
      <meta name="twitter:description" content="Betterment’s tools can keep you on track with the best chance of reaching your goals.">
      <meta name="twitter:title" content="How Betterment Manages Risks in Your Portfolio">
      <script type="application/ld+json">
         {
           ...
           "mainEntityOfPage": {
             "@type": "WebPage",
             "@id": "https://www.betterment.com/resources/how-betterment-manages-risk"
           },
           "headline": "How Betterment Manages Risks in Your Portfolio",
           "image": ["https://www.betterment.com/hubfs/Graphics/featured-images/chart-with-arrow-hitting-bullseye-target.jpg"],
           "datePublished": "Oct. 01, 2024",
           "dateModified": "Sep 9, 2022 11:59:02 AM",
           "author": {
               "@type": "Person",
               "name": "Betterment Editors",
               "url": "www.betterment.com/resources/author/betterment-editors"
           },
           "publisher": {
             "@type": "Organization",
             "name": "Betterment",
      ...
      <!-- /Added by GoogleTagManager integration -->
      <meta property="og:image" content="https://www.betterment.com/hubfs/Graphics/featured-images/chart-with-arrow-hitting-bullseye-target.jpg">
      <meta property="og:image:width" content="1200">
      <meta property="og:image:height" content="600">
      <meta property="og:image:alt" content="illustration of chart and bullseye">
      <meta name="twitter:image" content="https://www.betterment.com/hubfs/Graphics/featured-images/chart-with-arrow-hitting-bullseye-target.jpg">
      <meta name="twitter:image:alt" content="illustration of chart and bullseye">
      <meta property="og:url" content="https://www.betterment.com/resources/how-betterment-manages-risk">
   ...
   <body class="b4c_consumer_blog blog_post" data-contentid="84457968752" data-splitname="" data-contentmstamp="1729091111292" data-contentisab="false" data-contentabmaster="" data-pagename="How Betterment Manages Risks in Your Portfolio" data-localenv="false">
      <!--  Added by GoogleTagManager integration -->
                  ...
                  <div class="bt-section hero-spacer">
                     ...
                     <div class="bt-container bt-container_small">
                        <div class="blog-post-header">
                           <h1 class="bt-title2">How Betterment Manages Risks in Your Portfolio</h1>
                           <h2 class="bt-body1">Betterment’s tools can keep you on track with the best chance of reaching your goals.</h2>
                           <div class="blog-post-meta flex flex-middle">
                              <img class="author-thumbnail" src="../hubfs/Graphics/shared-assets/Favicon-navy-circle-1.png" alt="Image of Betterment Editors">
                     ...
                     <div class="bt-container bt-container_small">
                        <div class="blog-post-body">
                           <span id="hs_cos_wrapper_post_body" class="hs_cos_wrapper hs_cos_wrapper_meta_field hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="meta_field" data-hs-cos-type="rich_text">
                              ...
                              <p>Betterment’s tools can help manage risk and keep you on track toward your goals.</p>
                              <p>In this guide, we’ll:</p>
                              <ul>
                                 <li>Explain how Betterment provides allocation advice</li>
                                 <li>Talk about determining your personal risk level</li>
                                 <li>Walk through some of Betterment’s automated tools that help you manage risk</li>
                              ...
                              <p>This is why we use the Betterment auto-adjust—a glide path (aka formula) used for asset allocation that becomes more conservative as your target date approaches. We adjust the recommended allocation and portfolio weights of the glide path based on your specific goal and time horizon.</p>
                              ...
                              <p>Betterment’s auto-adjusted allocation not only saves you time, but it also gives you a smooth, tax-efficient path from higher risk to lower risk.</p>
                              <h3>Rebalancing</h3>
                              ...
                              <p>A high drift may expose you to more (or less) risk than you intended when you set the target allocation. Betterment automatically monitors your account for rebalancing opportunities to reduce drift, although rebalancing will likely not occur at a lower account balance. There are several different methods depending on the circumstances:</p>
                              <ul>
                              ...
                              <p>The yields you receive from the ETFs in Betterment’s 100% bond portfolio are the actual yields of the underlying assets after fees. Since we’re investing directly in funds that are paying prevailing market rates, you can feel confident that the yield you receive is fair and in line with prevailing rates.</p>
                           </span>
                        </div>
                     </div>
                     <div class="bt-container bt-container_small">
      ...
      <script>
         $(".copy-clip-container").click(function() {
            ...
            navigator.clipboard.writeText('https://www.betterment.com/resources/how-betterment-manages-risk').then(
            function() 
               { 
      ...
      <script type="text/javascript">
         ...
         _hsq.push(["setCanonicalUrl", "https:\/\/www.betterment.com\/resources\/how-betterment-manages-risk"]);
