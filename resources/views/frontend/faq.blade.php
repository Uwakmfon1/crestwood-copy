...
<html lang="en">
   <head data-ipt="Help Center">
      <meta charset="utf-8">
      <title>Betterment Help Center | Common questions</title>
      ...
      <link rel="stylesheet" href="../../hs-fs/hub/5274572/hub_generated/module_assets/64614019605/1729703944992/module_64614019605_toast_banner_global.min-1.css">
      ...
      <link rel="stylesheet" href="../../hs-fs/hub/5274572/hub_generated/module_assets/53653099091/1729703942844/module_53653099091_social_share.min-1.css">
      <link rel="stylesheet" href="../../hs-fs/hub/5274572/hub_generated/module_assets/145947863887/1729703937086/module_145947863887_footer_disclosures_set.min-1.css">
   ...
   <body class=" blog_listing" data-contentid="55357736012" data-splitname="" data-contentmstamp="1729802042370" data-contentisab="false" data-contentabmaster="" data-pagename="Help Center" data-localenv="false">
                  ...
                  <section class="bt-section hero-spacer help-center-list-hero bg-grey10">
                     <div class="bt-container">
                        <div class="content-area">
                           ...
                           <p>Explore frequently asked questions by new customers</p>
                        </div>
                     </div>
                  </section>
               </div>
               <section class="bt-section tag-results">
                  <div class="bt-container">
                     <div class="flex-wrap">
                        <aside class="flex-item cols col-1 sticky-sidebar toc-wrap" id="main-aside">
                           <div class="sticky">
                              <header class="flex-wrap flex-middle flex-spaceBetween sticky-header">
                                 <p class="headline bt-eyebrow">Table of content</p>
                                 <button class="toggle-aside" id="open-aside" aria-label="open jump to popup">
                                    <svg aria-hidden="true" fill="none" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24">
                                       <path fill-rule="evenodd" clip-rule="evenodd" d="M21 13H3v-2h18v2ZM21 18H3v-2h18v2ZM21 8H3V6h18v2Z" fill="currentColor"></path>
                                    </svg>
                                 </button>
                                 <button class="toggle-aside" id="close-aside" aria-label="close jump to popup">
                              ...
                              <ul>
                                 <li>
                                    <a href="#company-information" aria-current="true">Company information</a>
                                 </li>
                                 <li>
                                    <a href="#financial-security" aria-current="false">Financial security</a>
                                 </li>
                                 <li>
                                    <a href="#getting-started" aria-current="false">Getting started</a>
                                 </li>
                                 <li>
                                    <a href="#how-it-works" aria-current="false">How It Works</a>
                                 </li>
                                 <li>
                                    <a href="#managing-my-account" aria-current="false">Managing my account</a>
                                 </li>
                              </ul>
                           </div>
                        </aside>
                        <div class="flex-item cols col-2">
                           <div class="grouper-item item" data-offsettablet="-100" id="company-information">
                              <h2 class="bt-title3">Company information</h2>
                              <ul class="accordion-controls" aria-label="Accordion Control Group Buttons">
                                 ...
                                 <li class="item border-btGrey20">
                                    <button class="accordion-trigger bt-body1" aria-controls="content-what-is-your-mission-statement" aria-expanded="false">
                           ...
                           <div class="grouper-item item" data-offsettablet="-50" id="financial-security">
                              <h2 class="bt-title3">Financial security</h2>
                              <ul class="accordion-controls" aria-label="Accordion Control Group Buttons">
                                 <li class="item border-btGrey20">
                                 ...
                                 <li class="item border-btGrey20">
                                    <button class="accordion-trigger bt-body1" aria-controls="content-how-do-you-keep-my-money-safe" aria-expanded="false">
                           ...
                           <div class="grouper-item item" data-offsettablet="-50" id="getting-started">
                           ...
                           <div class="grouper-item item" data-offsettablet="-50" id="how-it-works">
                              <h2 class="bt-title3">How It Works</h2>
                              <ul class="accordion-controls" aria-label="Accordion Control Group Buttons">
                                 <li class="item border-btGrey20">
                                    <button class="accordion-trigger bt-body1" aria-controls="content-can-i-invest-in-an-individual-stock-or-fund-ie-sampp-500-index-or-apple" aria-expanded="false">
                           ...
                           <div class="grouper-item item" data-offsettablet="-50" id="managing-my-account">
                              <h2 class="bt-title3">Managing my account</h2>
                              <ul class="accordion-controls" aria-label="Accordion Control Group Buttons">
                                 <li class="item border-btGrey20">
                                 ...
                                 <li class="item border-btGrey20">
                                    <button class="accordion-trigger bt-body1" aria-controls="content-where-can-i-find-account-statements" aria-expanded="false">
                                 ...
                                 <li class="item border-btGrey20">
                                    <button class="accordion-trigger bt-body1" aria-controls="content-who-is-available-to-support-me-when-i-need-oneonone-advice" aria-expanded="false">
      ...
      <script src="../../hs-fs/hub/5274572/hub_generated/module_assets/64614019605/1729703944264/module_64614019605_toast_banner_global.min-1.js"></script>
      <script src="../../hs-fs/hub/5274572/hub_generated/module_assets/56913877023/1729703950189/module_56913877023_listing_hero.min-1.js"></script>
      <script>
      ...
      <script type="text/javascript">
         var hsVars = {
             render_id: "8e6ee354-af2f-49e7-8445-57f365a021ad",
             ticks: 1729802296411,
             page_id: 55357736012,
