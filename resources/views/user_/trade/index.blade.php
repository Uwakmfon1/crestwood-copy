                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    ...
                                    <div class="flex-fill">
                                        <span class="d-block fw-medium fs-14">BUY trade</span>
                                        <span class="d-block text-muted fs-12">Assets</span>
                                    </div>
                                    <div class="text-end">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div
                                            class="d-flex gap-2 flex-wrap align-items-center justify-content-between p-3 bg-primary-transparent border">
                                            ...
                                            <div class="fs-12 text-end">
                                                ...
                                                <span class="d-block text-primary">+$1,780.80</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class=" fs-12 text-end">
                                                <span class="text-danger d-block">4.02%<i
                                                        class="ti ti-arrow-bear-right"></i></span>
                                                <span class="d-block text-primary">+$4,125.63</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class=" fs-12 text-end">
                                                <span class="text-success d-block">5.14%<i
                                                        class="ti ti-arrow-bear-right"></i></span>
                                                <span class="text-primary d-block">+$936.30</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <div
                                            class="d-flex flex-wrap align-items-center justify-content-between p-3 border rounded bg-primary-transparent">
                                            <div class="d-flex flex-fill align-items-center">
                                                <div class="me-2">
                                                    <span class="avatar avatar-sm bg-primary p-2">
                                        ...
                                        <div
                                            ...
                                            <div class=" fs-12 text-end">
                                                <span class="text-danger d-block">1.24%<i
                                                        class="ti ti-arrow-bear-right"></i></span>
                                                <span class="text-primary d-block">+$3,221.29</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table text-nowrap table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-start gap-3">
                                                ...
                                                <div class="flex-fill lh-1">
                                                    <a href="{{ route('trade.show', ['stock' => $stock['id'], 'symbol' => $stock['symbol']]) }}" class="d-block mb-1 fs-14 fw-medium">{{ $stock->name }}</a>
                                        ...
                                        <td>
                                            <button class="btn btn-success btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $stock->id }}buy">
                                                BUY
                                            </button>
                                        </td>
                                    </tr>
