            ...
            <div class="col-xl-3">
                ...
                <div class="card custom-card bg-success">
                    <div class="card-body p-4">
                        <div class="">
                            <div class="text-fixed-white mb-2">Today's Profit<span class="ms-2 d-inline-block text-fixed-white op-5"><i class="fe fe-arrow-up-right"></i>0.25%</span>
                            </div>
                            <h4 class="fw-semibold mb-0 text-fixed-white">{{ number_format(0, 2) }} <sub class="fs-12 op-8 d-inline-flex">USD</sub></h4>
                        </div>
