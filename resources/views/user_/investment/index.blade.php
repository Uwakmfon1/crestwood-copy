    ...
    <div class="container-fluid">
        ...
        <div
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('packages') }}" class="btn btn-white btn-wave border-0 me-0 fw-normal waves-effect waves-light">
                    <i class="ri-filter-3-fill me-2"></i>Plans
                </a>
                <a href="{{ route('investments.history') }}" class="btn btn-primary btn-wave waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#nairaWithdrawalModal">
                    <i class="ri-upload-2-line me-2"></i> History
                </a>
            </div>
        </div>
        <!-- End::page-header -->
                                ...
                                <div class="p-2 my-2 bg-white-transparent rounded">
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <div>
                                            ...
                                            <span class="fs-16 fw-semibold text-left" style="padding-right: 40px;">250.00 USD</span> 
                                        </div>
                                    </div>
                                    <div class="mt-1"> 
                                    </div>
                                ...
                                <div class="p-2 my-2 bg-white-transparent rounded">
                                    <div class="d-flex align-items-center justify-content-start">
                                        ...
                                        <div>
                                            ...
                                            <span class="fs-16 fw-semibold text-left" style="padding-right: 40px;">77.89 USD</span> 
                                        </div>
                                    </div>
                                    <div class="mt-1"> 
                                    </div>
