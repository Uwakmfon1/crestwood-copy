...
class NotificationService 
{
    ...
    public  function sendSavingsNotification($savings)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($savings->user, 'Investment Created', $msg, $description);
    ...
    public  function sendInvestmentCreatedNotification($investment)
    {
        try {
            ...
            $this->sendAdminNotification($investment->user, 'Investment Created', $msg, $description);
        } catch (\Exception $e) {
    ...
    public  function sendTradeCancelledNotification($trade) //
    {
        ...
        try {
            ...
            $this->sendAdminNotification($trade->user, 'Deposit Successful', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendDepositSuccessfulNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Deposit Successful', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendDepositQueuedNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Deposit Queued', $msg, $description);
        }catch (\Exception $e) {
    ...
    public  function sendDepositCancelledNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Deposit Declined', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendWithdrawalSuccessfulNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Withdrawal Successful', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendWithdrawalQueuedNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Withdrawal Queued', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendWithdrawalCancelledNotification($transaction)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Withdrawal Declined', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendTransferSuccessfulNotification($transaction, $from, $to)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($transaction->user, 'Funds Transfer Successful', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendSavingsCreatedNotification($savings)
    {
        ...
        try {
            ...
            $this->sendAdminNotification($savings->user, 'Savings Plan Created', $msg, $description);
        }catch (\Exception) {
            logger('There was an error sending the email');
        }
    }
    ...
    public  function sendTradeNotification($trade, $type, $method)
    {
        try {
            ...
            $this->sendAdminNotification($trade->user, 'Trade Notification', $msg, $description);
        } catch (\Exception $e) {
            // Log the error message
    ...
    private function sendAdminNotification($user, $title, $msg, $description)
    {
