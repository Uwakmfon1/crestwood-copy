...
class User extends Authenticatable implements MustVerifyEmail, JWTSubject
{
    ...
    public static array $countries = [
        ...
        ['id' => 8,'code' => 'AQ' ,'name' => "Antarctica",'phonecode' => 672],
        ...
        ['id' => 29,'code' => 'BV','name' => "Bouvet Island",'phonecode' => 55],
        ...
        ['id' => 78,'code' => 'TF','name' => "French Southern Territories",'phonecode' => 262],
        ...
        ['id' => 96,'code' => 'HM','name' => "Heard and McDonald Islands",'phonecode' => 672],
        ...
        ['id' => 174,'code' => 'PN','name' => "Pitcairn Island",'phonecode' => 64],
        ...
        ['id' => 203,'code' => 'GS','name' => "South Georgia",'phonecode' => 500],
    ...
    {
        return $this->nairaWallet['balance'] >= $amount;
    }

    public function hasSufficientGoldToTrade($units): bool
    {
        return $this->goldWallet['balance'] >= $units;
    }

    public function hasSufficientSilverToTrade($units): bool
    {
        return $this->silverWallet['balance'] >= $units;
    }
    ...
    public function authenticatedWithSocials(): bool
    {
        return $this['facebook_id'] || $this['google_id'];
    }

    public function canBeDeleted($duration): bool
    {
        $newDate = date('Y-m-d H:i:s', strtotime(now().'+ '.$duration));
        return is_null($this['email_verified_at']) && $this['created_at']->lt(Carbon::parse($newDate));
    }
