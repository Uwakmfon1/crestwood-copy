...
class PaymentController extends Controller
{
    ...
    {
        return $this->paymentService->handleMonnifyCallback($request);
    }
    // public function handleMonnifyCallback(Request $request)
    // {
    ...
    {
        return $this->paymentService->handlePaymentWebhook($request, $gateway);
    }
    ...
    public function initializeOnlineTransaction($amount, $data)
    {
        return $this->paymentService->initializeOnlineTransaction($amount,$data);   
    }
